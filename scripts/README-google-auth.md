...
Environment secrets：https://cursor.com/dashboard/cloud-agents/environments/r/github.com/chrisyangwang/investment  
...
| **`GOOGLE_ACCOUNT_EMAIL`** | `chrisyangwang@gmail.com` | 可选（脚本默认该邮箱） |
